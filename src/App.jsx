...
import image1 from "./assets/images/weather-with-you.png";
import image2 from "./assets/images/one-piece.png";
import image3 from "./assets/images/boruto.png";
import image4 from "./assets/images/spy.png";
import image5 from "./assets/images/attack-on-titan.png";
import image6 from "./assets/images/captsu.png";
import image7 from "./assets/images/aoashi.png";
...
function App() {
  const [mainCardItem, setMainCardItem] = useState(data[0]);

  return (
    <div className="app-container">
      <Header />

      <h3 className="text-explore">Explore</h3>

      <p className="text-question">What are you gonna watch today ?</p>

      <MainCard mainCardItem={mainCardItem} />

      <div>
        <h2>New release</h2>
        <div className="miner-cards-ctn">
          {data.slice(1).map((item) => (
            <MinerCard
              key={item.id}
              {...item}
              onSelectAnime={() => setMainCardItem(item)}
            />
          ))}
        </div>
      </div>
